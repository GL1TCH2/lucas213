function startClassification() //função para poder usar o audio do microfone
{
  navigator.mediaDevices.getUserMedia({ audio: true});
   //armazenando o modelo de audio criado do teachable machine
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/LI4JRgIRk/model.json', modelReady);
}
...
function gotResults(error, results) {
  if (error) {
    ...
    if (results[0].label == "caixa") {
      img.src = 'aliens-01.gif';
      img1.src = 'aliens-02.png';
      img2.src = 'aliens-03.png';
      img3.src = 'aliens-04.png';
    } else if (results[0].label == "darkslide") {
      img.src = 'aliens-01.png';
      img1.src = 'aliens-02.gif';
      img2.src = 'aliens-03.png';
      img3.src = 'aliens-04.png';
    } else if (results[0].label == "descendo a rampa") {
      img.src = 'aliens-01.png';
      img1.src = 'aliens-02.png';
      img2.src = 'aliens-03.gif';
      img3.src = 'aliens-04.png';
    }else if (results[0].label == "skate"){
      img.src = 'aliens-01.png';
      img1.src = 'aliens-02.png';
      img2.src = 'aliens-03.png';
